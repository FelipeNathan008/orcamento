...
@section('title', 'Cadastrar Novo Log de Status')
...
@section('content')
    <div class="max-w-6xl mx-auto p-8 mt-10 mb-10 font-poppins">
        ...
        <h1 class="text-3xl font-bold text-custom-dark-text mb-8 text-center">
            Cadastro de Novo Log de Status
        </h1>
        ...
        <form action="{{ route('log_status.store') }}" method="POST" id="logStatusForm" class="space-y-6">
            @csrf
                ...
                <div>
                        ...
                        <select name="status_mercadoria_id_status" id="status_mercadoria_id_status"
                            ...
                            @foreach ($status as $item)
                                <option value="{{ $item->id_status_merc }}"
                                    {{ old('status_mercadoria_id_status') == $item->id_status_merc ? 'selected' : '' }}>
                                    {{ $item->nome_status }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mt-6">
                        ...
                        <input type="number" name="log_id_orcamento" id="log_id_orcamento"
                            ...
                            value="{{ old('log_id_orcamento') }}" required>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <input type="number" name="log_id_cliente" id="log_id_cliente"
                            ...
                            value="{{ old('log_id_cliente') }}" required>
                    ...
                    <div class="mt-6">
                        ...
                        <input type="text" name="log_nome_status" id="log_nome_status"
                            ...
                            maxlength="90"
                            value="{{ old('log_nome_status') }}" required>
                    ...
                    <div class="mt-6">
                        ...
                        <select name="log_situacao" id="log_situacao"
                            ...
                            required>
                            <option value="">Selecione</option>
                            <option value="1" {{ old('log_situacao') == '1' ? 'selected' : '' }}>Ativo</option>
                            <option value="0" {{ old('log_situacao') == '0' ? 'selected' : '' }}>Inativo</option>
                        </select>
