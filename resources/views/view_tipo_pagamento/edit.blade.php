<!-- resources/views/tipo_pagamento/edit.blade.php -->
...
<div class="max-w-6xl mx-auto p-8 mt-10 mb-10 font-poppins">
    {{-- Título centralizado --}}
    <h1 class="text-3xl font-bold text-custom-dark-text mb-8 text-center">Editar Tipo de Pagamento</h1>

    {{-- Formulário --}}
    <form action="{{ route('tipo_pagamento.update', $tipo->id_tipo_pagamento) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
