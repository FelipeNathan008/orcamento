...
@section('content')
    ...
    <div class="max-w-6xl mx-auto p-8 mt-10 mb-10 font-poppins">
        ...
        {{-- Exibição de erros de validação gerais do Laravel, se houver --}}
        @if ($errors->any() && !$errors->has('clie_orc_celular') && !$errors->has('clie_orc_telefone'))
                ...
                <div>
                    ...
                    <div class="mt-6">
                        ...
                        <input type="text" name="clie_orc_doc_numero" id="clie_orc_doc_numero"
                            ...
                            value="{{ old('clie_orc_doc_numero', $clienteOrcamento->clie_orc_tipo_doc === 'CPF' ? $clienteOrcamento->clie_orc_cpf : ($clienteOrcamento->clie_orc_tipo_doc === 'CNPJ' ? $clienteOrcamento->clie_orc_cnpj : ($clienteOrcamento->clie_orc_tipo_doc === 'RG' ? $clienteOrcamento->clie_orc_rg : null))) }}"
                            required>
