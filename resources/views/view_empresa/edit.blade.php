                ...
                <div class="md:col-span-2">
                    ...
                    <div>
                        ...
                        <input type="text"
                               ...
                               maxlength="85"
                               value="{{ old('emp_nome', $empresa->emp_nome) }}"
                               required>
                        @error('emp_nome')
                ...
                <div>
                    ...
                    <div class="mt-0"> {{-- Removido mt-6 para alinhar com o campo acima --}}
                        ...
                        <input type="text"
                               ...
                               maxlength="45"
                               value="{{ old('emp_cidade', $empresa->emp_cidade) }}"
                               required>
                        @error('emp_cidade')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mt-6">
                        ...
                        <input type="text"
                               ...
                               maxlength="45"
                               value="{{ old('emp_bairro', $empresa->emp_bairro) }}"
                               required>
                        @error('emp_bairro')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mt-6">
                        ...
                        <input type="text"
                               ...
                               maxlength="85"
                               value="{{ old('emp_logradouro', $empresa->emp_logradouro) }}"
                               required>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <input type="text"
                               ...
                               maxlength="18"
                               value="{{ old('emp_cnpj', $empresa->emp_cnpj) }}"
                               required>
                        @error('emp_cnpj')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mt-6">
                        ...
                        <select name="emp_uf"
                            ...
                            @php
                                ...
                                $selectedUf = old('emp_uf', $empresa->emp_uf ?? '');
                            @endphp
                    ...
                    <div class="mt-6">
                        ...
                        <input type="text"
                               ...
                               maxlength="9"
                               value="{{ old('emp_cep', $empresa->emp_cep) }}"
                               required>
                        @error('emp_cep')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
